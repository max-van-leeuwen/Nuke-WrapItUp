...
class Ui_Dialog(object):
	...
	def retranslateUi(self, Dialog):
		...
		Dialog.setWindowTitle(_translate("Dialog", "Nuke打包工具  [WrapItUp - 1.8]         作者- Max van Leeuwen           SkydreamVFX汉化"))
		self.ListCopyPaths.setToolTip(_translate("Dialog", "<html><head/><body><p>在左侧框内所有文件都复制打包到指定的路径.</p></body></html>"))
		self.ListIgnorePaths.setToolTip(_translate("Dialog", "<html><head/><body><p>在右侧框内所有文件都不会复制打包.</p></body></html>"))
		self.SendToIgnore.setToolTip(_translate("Dialog", "选中并按下此按钮会将左侧所选的项目移至右侧，并在打包时忽略."))
		self.SendToIgnore.setText(_translate("Dialog", ">>"))
		self.SendToCopy.setToolTip(_translate("Dialog", "选中并按下此按钮会将右侧所选的项目移至左侧，并在打包时打包这些文件及项目."))
		self.SendToCopy.setText(_translate("Dialog", "<<"))
		self.PackedPath.setToolTip(_translate("Dialog", "<html><head/><body><p>所有数据收集到的文件夹的位置.<br/>确保这是个空文件夹.</p></body></html>"))
		self.ChoosePackedPathButton.setToolTip(_translate("Dialog", "<html><head/><body><p>所有数据收集到的文件夹的位置.<br/>确保这是个空文件夹.</p></body></html>"))
		self.ChoosePackedPathButton.setText(_translate("Dialog", "选择文件夹"))
		self.LCopy.setText(_translate("Dialog", "打包"))
		self.LIgnore.setText(_translate("Dialog", "忽略"))
		self.LCurrItemItemPath.setToolTip(_translate("Dialog", "所选文件的路径."))
		self.LCurrItemItemPath.setText(_translate("Dialog", "所选文件的路径"))
		self.LPackedItemPath.setToolTip(_translate("Dialog", "<html><head/><body><p>打包完成后的路径预览.</p></body></html>"))
		self.LPackedItemPath.setText(_translate("Dialog", "打包完成后的路径预览"))
		self.CurrItemPath.setText(_translate("Dialog", "-"))
		self.PackedItemPath.setText(_translate("Dialog", "-"))
		self.LWebsite.setToolTip(_translate("Dialog", "作者网站!"))
		...
		self.LPath.setToolTip(_translate("Dialog", "<html><head/><body><p>要将所有数据收集到的文件夹的位置.<br/>确保这是一个空文件夹.</p></body></html>"))
		self.LPath.setText(_translate("Dialog", "选择要保存的文件夹:"))
		self.LFiles.setToolTip(_translate("Dialog", "<html><head/><body><p>当前所选文件的 个数(单文件)/帧数(序列文件).</p></body></html>"))
		self.LFiles.setText(_translate("Dialog", "当前所选的文件数"))
		self.CurrItemFiles.setText(_translate("Dialog", "-"))
		self.TotalProgress.setToolTip(_translate("Dialog", "<html><head/><body><p>打包进度.</p></body></html>"))
		self.Refresh.setToolTip(_translate("Dialog", "<html><head/><body><p>重新检查当前的Nuke脚本内的所有素材和其他文件.</p></body></html>"))
		self.Refresh.setText(_translate("Dialog", "刷新"))
		self.Start.setToolTip(_translate("Dialog", "<html><head/><body><p>点击开始打包.<br/>完成后会打开文件夹.</p></body></html>"))
		self.Start.setText(_translate("Dialog", "开始打包..."))
		self.Interrupt.setToolTip(_translate("Dialog", "<html><head/><body><p>Stop/退出.</p></body></html>"))
		self.Interrupt.setText(_translate("Dialog", "停止打包"))
		self.LSize.setToolTip(_translate("Dialog", "<html><head/><body><p>所选文件的大小.</p></body></html>"))
		self.LSize.setText(_translate("Dialog", "当前文件占用空间"))
		self.CurrItemSize.setText(_translate("Dialog", "-"))
		self.LTotalCopySize.setToolTip(_translate("Dialog", "要打包的所有文件的总占用空间."))
		self.LTotalCopySize.setText(_translate("Dialog", "总占用空间"))
		self.TotalCopySize.setToolTip(_translate("Dialog", "要打包的所有文件的总占用空间"))
		self.TotalCopySize.setText(_translate("Dialog", "0"))
		self.IgnoredLabel.setText(_translate("Dialog", "已被忽略!"))
		self.CurrentCopyItem.setText(_translate("Dialog", "正在加载..."))
		self.GoToFolder.setToolTip(_translate("Dialog", "<html><head/><body><p>打开当前所选文件所在的文件夹.<br/><br/>alt/option+shift+r</p></body></html>"))
		self.GoToFolder.setText(_translate("Dialog", "定位到文件夹"))
		self.GoToFolder.setShortcut(_translate("Dialog", "Alt+Shift+R"))
		self.ItemProgress.setToolTip(_translate("Dialog", "<html><head/><body><p>进度.</p></body></html>"))
		self.RelinkPaths.setToolTip(_translate("Dialog", "<html><head/><body><p>创建一个工程文件副本，在这个副本中，所有素材路径会重新填写为打包位置的素材路径.</p></body></html>"))
		self.RelinkPaths.setText(_translate("Dialog", "重新链接所有素材到打包位置"))
		self.RelativeRelink.setToolTip(_translate("Dialog", "<html><head/><body><p>创建一个工程文件副本，在这个副本中，所有文件路径用以下路径前缀重新链接: [python {nuke.script_directory()}]<br/><br/>这样做的好处是整个文件夹换到别的位置或者在别的机器上打开仍然不会报路径错误，因为素材读取的位置是相对工程文件脚本的，确保工程文件所在的文件夹里“media”这个文件夹不改变和工程文件的相对位置，工程文件打开就永远不会报找不到素材路径的错误.</p></body></html>"))
		self.RelativeRelink.setText(_translate("Dialog", "重新链接所有素材为相对路径"))
		self.LParentDirectories.setToolTip(_translate("Dialog", "<html><head/><body><p>找到的素材所在路径里要保留的父目录的层级数量.<br/><br/>举个栗子:<br/>现在有个素材文件 /path/to/image/files/file_####.exr 如果数值设为3，则在打包完成后打包所在的位置会有如下文件:<br/><br/>../MEDIA/image/files/file_####.exr<br/><br/><br/>如果没有勾选 \'打包素材放入带有原始文件路径的父目录文件夹\' 也就是没有选中, 那么这个数值不要设置的太小.<br/>如果存在相同名称父目录的素材文件可能会被覆盖或合并在一起.<br/>建议设置为3</p></body></html>"))
		self.LParentDirectories.setText(_translate("Dialog", "要保留的文件父目录层级数"))
		self.ParentDirectories.setToolTip(_translate("Dialog", "<html><head/><body><p>找到的素材所在路径里要保留的父目录的层级数量.<br/><br/>For instance:<br/>举个栗子:<br/>现在有个素材文件 /path/to/image/files/file_####.exr 如果数值设为3，则在打包完成后打包所在的位置会有如下文件:<br/><br/>../MEDIA/image/files/file_####.exr<br/><br/><br/>如果没有勾选 \'打包素材放入带有原始文件路径的父目录文件夹\' 也就是没有选中, 那么这个数值不要设置的太小.<br/>如果存在相同名称父目录的素材文件可能会被覆盖或合并在一起.</p></body></html>"))
		self.NodeNameFolder.setToolTip(_translate("Dialog", "<html><head/><body><p>将每一个素材分别放在一个文件夹里，这个Read节点的名字会设置为文件夹的名字。.<br/><br/>这样有助于查找哪个素材属于新工程中的哪个节点，并且是针对不同素材项的父文件夹具有相同名称时可能出现的这类问题的一个查询办法，当文件过多时也不容易混淆.</p></body></html>"))
		self.NodeNameFolder.setText(_translate("Dialog", "打包素材放入带有原始文件路径的父目录文件夹"))
		self.SettingPages.setTabText(self.SettingPages.indexOf(self.MainSettings), _translate("Dialog", "素材"))
		self.CopyFontDir.setToolTip(_translate("Dialog", "<html><head/><body><p>如果目前工程里面设置了自定义的字体路径，那么就顺带一起打包.</p></body></html>"))
		self.CopyFontDir.setText(_translate("Dialog", "打包自定义字体文件(如果有)"))
		self.CopyGizmos.setToolTip(_translate("Dialog", "<html><head/><body><p>如果Nuke脚本中使用了gzimo插件，会自动收集并生成init.py和menu.py文件，在别的电脑上安装会变得更轻松，但如果在别的电脑上打开而且他们没有安装这些gizmo，打开工程仍然会报错。<br/> <br/>这个功能不适用于所有插件，<br/>例如不适用后缀名为（.dll，.so，.dylib）的插件.</p></body></html>"))
		self.CopyGizmos.setText(_translate("Dialog", "打包 gizmos"))
		self.SettingPages.setTabText(self.SettingPages.indexOf(self.tab), _translate("Dialog", "附加组件"))
		self.ContinueOnError.setToolTip(_translate("Dialog", "<html><head/><body><p>如果发生错误仍会继续复制打包。<br/>如果存在错误，请检查所选目录文件夹生成的log.txt文件.</p></body></html>"))
		self.ContinueOnError.setText(_translate("Dialog", "如果发生错误仍会继续复制打包"))
		self.ExitOnFinish.setToolTip(_translate("Dialog", "<html><head/><body><p>打包完成时（或出错后，如果禁用了上面“出错也继续打包”，则完全关闭Nuke）。<br/> <br/>对于在许可证上使用了有限数量的浮动许可证的电脑有点用.</p></body></html>"))
		self.ExitOnFinish.setText(_translate("Dialog", "打包完成后关闭Nuke"))
		self.CSVSeparator.setToolTip(_translate("Dialog", "<html><head/><body><p>设置日志文件的CSV列分隔符.</p></body></html>"))
		self.CSVSeparator.setItemText(0, _translate("Dialog", ";"))
		self.CSVSeparator.setItemText(1, _translate("Dialog", ","))
		self.LCSVSeparator.setToolTip(_translate("Dialog", "<html><head/><body><p>设置日志文件的CSV列分隔符.</p></body></html>"))
		self.LCSVSeparator.setText(_translate("Dialog", "日志文件的 CSV 分隔符 选项"))
		self.SettingPages.setTabText(self.SettingPages.indexOf(self.Misc), _translate("Dialog", "其他"))
		self.License.setToolTip(_translate("Dialog", "<html><head/><body><p>在命令行中运行Nuke时（重新链接时），在内部使用此标志。<br/> -t标志使用nuke_r许可证，-ti标志使用nuke_i许可证。</p></body></html>"))
		self.License.setItemText(0, _translate("Dialog", "-t"))
		self.License.setItemText(1, _translate("Dialog", "-ti"))
		self.LLicense.setToolTip(_translate("Dialog", "<html><head/><body><p>在命令行中运行Nuke时（重新链接时）在内部使用此标志。<br/> -t标志使用nuke_r许可证，-ti标志使用nuke_i许可证.</p></body></html>"))
		self.LLicense.setText(_translate("Dialog", "重新链接 license"))
		self.GoToRootFolder.setToolTip(_translate("Dialog", "<html><head/><body><p>打开当前选择的文件夹.</p></body></html>"))
		self.GoToRootFolder.setText(_translate("Dialog", "打开文件夹"))
		self.GoToNode.setToolTip(_translate("Dialog", "<html><head/><body><p>打开当前所选文件所在的文件夹.<br/><br/>alt/option+shift+r</p></body></html>"))
		self.GoToNode.setText(_translate("Dialog", "定位到节点"))
...
def _Start(silent = False, nk = '', startnow = False, out = '', nodenamefolder = True, parentdircount = 3, relinked = True, relativerelinked = True, media = True, skipdisablednodes = False, fonts = True, gizmos = True, csvcommas = False, licinteractive = False):
	...
	def Finished(isError):
		...
		if ((isError is not 'USER') and (WExitOnFinish.isChecked())):
			...
			if(isError == ''):
				...
				window.close()
				nuke.message(u"打包完成！ 发生了一些错误。\n文件夹会马上打开，有关错误的详细信息，请参阅日志文件。!")
				OpenFolder(WIU_PackedPath)
			
			elif(isError == 'USER'):

				nuke.message("打包已取消！ 文件夹会立即打开.")
				window.activateWindow()
				OpenFolder(WIU_PackedPath)
	...
	def StartCopy():
		...
		q = True
		if not silent:
			q = nuke.ask(u"开始打包 " + WTotalCopySize.text() + '?\n' + '打包路径: ' + WIU_PackedPath + '\n如果选定的打包路径内有任何现有文件都会被覆盖.')
			window.activateWindow()
